...
public class EvolutionSceneModel : MonoBehaviour {
    ...
    public void deleteSelectedCard()
    {
        ...
        cardsToDelete.Add(selectedCardUI.GetComponent<CardHolderES>().getCard());        
    ...
    private GameObject createUICard(Card card) {
        ...
        cardObject.GetComponent<CardHolderES>().setCard(card);        
        return cardObject;
    }
